...
namespace GP_1
{
    public partial class ShowIncome : Form
    {
        ...
        public ShowIncome(int userId = 1)
        {
            InitializeComponent();
        ...
        private void ShowIncome_Load(object sender, EventArgs e)
        {
        ...
        {
            Panel[] cards = { cardTotal, cardIncome, cardAverage };
            Color[] accentColors = {
                UITheme.DarkNavy,
                UITheme.IncomeGreen,
                UITheme.BalanceBlue
        ...
        private void LoadCategoryCheckboxes()
        {
            ...
            try
            {
                using (NpgsqlConnection con = Database.CreateConnection())
                {
                    ...
                    string sql = @"SELECT DISTINCT c.c_category_name 
                                   ...
                                   WHERE LOWER(tt.c_type_name) = 'income' 
            ...
            {
                categories.AddRange(new[] { "Salary", "Freelance", "Investment", "Bonus", "Rental Income", "Other Income" });
            }
        ...
        private void ApplyFilters()
        {
            ...
            // Category filter: If NO checkbox is selected, show all income records!
        ...
        {
            UITheme.StyleDataGridView(dgvIncome);
            ...
            dgvIncome.Columns.AddRange(colDate, colCategory, colDesc, colAmount);
            dgvIncome.CellFormatting += DgvIncome_CellFormatting;
        }

        private void DgvIncome_CellFormatting(object? sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.RowIndex < 0 || e.RowIndex >= dgvIncome.Rows.Count || e.CellStyle == null) return;
        ...
        private void LoadTransactions(string type)
        {
            ...
            {
                MessageBox.Show(
                    "Error loading income data: " + ex.Message,
                    "Database Error",
            ...
            dgvIncome.DataSource = dataTable.DefaultView;
            ApplyFilters();
        }
        ...
        private void UpdateStats()
        {
            ...
            {
                totalIncome += Convert.ToDecimal(rowView["c_amount"]);
            }

            decimal avg = count > 0 ? totalIncome / count : 0;
